...
class _ManageStockScreenState extends State<ManageStockScreen> {
  ...
  void _openEdit(String docId, Map<String, dynamic> data) {
    Navigator.push(
      context,
      MaterialPageRoute(
        builder: (_) => EditProductScreen(productId: docId, initialData: data),
      ),
    );
  }
        ...
        child: Column(
          ...
          children: [
            ...
            ListTile(
              ...
              subtitle: const Text('Update price, stock, photo, or details'),
              onTap: () {
                Navigator.pop(context);
                _openEdit(docId, data);
              },
            ),
          ...
          Padding(
            ...
            child: Row(
              children: [
                ...
                Text(
                  'Tap to edit • Hold for more options',
                  style: TextStyle(
